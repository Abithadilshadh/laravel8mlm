...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('font_assets/assets/img/favicons/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('font_assets/assets/img/favicons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('font_assets/assets/img/favicons/favicon-16x16.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('font_assets/assets/img/favicons/favicon.png')}}">
    <link rel="manifest" href="{{ asset('font_assets/assets/img/favicons/manifest.json')}}">
    <meta name="msapplication-TileImage" content="{{ asset('font_assets/assets/img/favicons/mstile-150x150.png')}}">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{ asset('font_assets/assets/css/theme.css')}}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="{{ asset('font_assets/assets/img/logo.svg')}}" height="31" alt="logo" /></a>
      ...
      <section class="pt-7">
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end"><img class="pt-7 pt-md-0 img-fluid" src="{{ asset('font_assets/assets/img/hero/hero-img.png')}}" alt="" /></div>
          </div>
        </div>
      </section>
      ...
      <section class="pt-5 pt-md-9 mb-6" id="feature">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block" style="background-image:url({{ asset('font_assets/assets/img/category/shape.png')}});opacity:.5;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{ asset('font_assets/assets/img/category/icon1.png')}}" width="75" alt="Feature" />
              <h4 class="mb-3">First click tests</h4>
              <p class="mb-0 fw-medium text-secondary">While most people enjoy casino gambling,</p>
            </div>
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{ asset('font_assets/assets/img/category/icon2.png')}}" width="75" alt="Feature" />
            ...
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{ asset('font_assets/assets/img/category/icon3.png')}}" width="75" alt="Feature" />
              <h4 class="mb-3">Preference tests</h4>
              <p class="mb-0 fw-medium text-secondary">The Myspace page defines the individual.</p>
            </div>
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="{{ asset('font_assets/assets/img/category/icon4.png')}}" width="75" alt="Feature" />
      ...
      <section class="pt-5" id="validation">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="{{ asset('font_assets/assets/img/validation/validation.png')}}" alt="" /></div>
          </div>
        </div><!-- end of .container-->
      ...
      <section class="pt-5" id="manager">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6"><img class="img-fluid" src="{{ asset('font_assets/assets/img/manager/manager.png')}}" alt="" /></div>
            <div class="col-lg-6">
              ...
              <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="{{ asset('font_assets/assets/img/manager/tick.png')}}" width="35" alt="tick" />
      ...
      <section class="pt-5" id="marketer">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="{{ asset('font_assets/assets/img/marketer/marketer.png')}}" alt="" /></div>
          </div>
        </div><!-- end of .container-->
      ...
      <section class="py-md-11 py-8" id="superhero">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block background-position-top" style="background-image:url({{ asset('font_assets/assets/img/superhero/oval.png')}});opacity:.5; background-position: top !important ;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="{{ asset('font_assets/assets/img/marketing/marketing01.png')}}" alt="" />
            ...
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="{{ asset('font_assets/assets/img/marketing/marketing02.png')}}" alt="" />
                <div class="card-body ps-0">
                  <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
            ...
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="{{ asset('font_assets/assets/img/marketing/marketing03.png')}}" alt="" />
                <div class="card-body ps-0">
                  <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
      ...
      <section class="pb-2 pb-lg-5">
        ...
        <div class="container">
          <div class="row border-top border-top-secondary pt-7">
            <div class="col-lg-3 col-md-6 mb-4 mb-md-6 mb-lg-0 mb-sm-2 order-1 order-md-1 order-lg-1"><img class="mb-4" src="{{ asset('font_assets/assets/img/logo.svg')}}" width="184" alt="" /></div>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{ asset('font_assets/vendors/@popperjs/popper.min.js')}}"></script>
    <script src="{{ asset('font_assets/vendors/bootstrap/bootstrap.min.js')}}"></script>
    <script src="{{ asset('font_assets/vendors/is/is.min.js')}}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{ asset('font_assets/vendors/fontawesome/all.min.js')}}"></script>
    <script src="{{ asset('font_assets/assets/js/theme.js')}}"></script>
